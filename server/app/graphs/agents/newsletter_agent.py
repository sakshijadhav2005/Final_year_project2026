...
from app.graphs.tools import fetch_industry_news

logger = structlog.get_logger("newsletter_agent")
...
class NewsletterAgent(BaseCreatorAgent):
    ...
    async def generate(
        ...
        try:
            ...
            logger.error("newsletter_agent_tool_error", error=str(exc))
