...
from sqlalchemy import Date, Enum as SqlEnum, ForeignKey, String, Uuid
...
class Event(TimestampMixin, Base):
    ...
    type: Mapped[EventType] = mapped_column(SqlEnum(EventType, native_enum=False), nullable=False, default=EventType.OTHER)
