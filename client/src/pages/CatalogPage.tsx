                ...
                <div className="grid grid-cols-1 gap-13 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., Pune, Virtual, or San Francisco"
                      className="w-full rounded-card border border-black/10 dark:border-white/10 bg-canvas-light dark:bg-white/[0.04] px-13 py-10 text-xs text-ink-light dark:text-ink-dark focus:border-gold focus:outline-none transition-colors"
                    />
                  </div>
